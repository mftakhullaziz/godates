...
const (
	...
	FindAllUserAccountsListRecord              = `SELECT a.account_id, u.user_id, a.verified, a.username, u.full_name FROM users u INNER JOIN accounts a ON u.account_id = a.account_id`
)
