...
const (
	...
	FindAllUserAccountsViewInPremiumFirstListRecord = `SELECT a.account_id, u.user_id, a.verified, a.username, u.full_name, u.gender, u.bio, u.age, u.address 
													FROM users u INNER JOIN accounts a ON u.account_id = a.account_id 
													WHERE a.account_id != ?`

	FindAllUserAccountsViewInPremiumSecondListRecord = `SELECT a.account_id, u.user_id, a.verified, a.username, u.full_name, u.gender, u.bio, u.age, u.address 
	...
	FindAllUserAccountsView10InFirstHitListRecord = `SELECT a.account_id, u.user_id, a.verified, a.username, u.full_name, u.gender, u.bio, u.age, u.address 
													...
													AND a.account_id != ?
													AND a.account_id NOT IN (SELECT DISTINCT sh2.account_id_identifier
														FROM selection_histories sh2 
														WHERE sh2.selection_date = CURDATE())
													ORDER BY RAND() 
													LIMIT 10;`
